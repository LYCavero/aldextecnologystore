...
<body>
    <div class="contenedor-principal">
        ...
        <div class="contenedor-banner">
            <img src="img/banner-principal-recortado.png">
            <div class="banner-contenido">
                <p class="banner-contenido-titulo">TODO EN UN SOLO LUGAR</p>
                <p class="banner-contenido-subtitulo">Productos al mejor precio y soporte técnico especializado</p>
            </div>
        </div>
